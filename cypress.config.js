      ...
      on("task", {
        async clearDatabase() {
          ...
          try {
            ...
            // 2. Seed Expandido Sincronizado (14 itens)
            const seedQuery = `
              ...
              ('Mouse Wireless Ultra-Light', 'Apenas 55g, sensor de 30K DPI e bateria para 80 horas.', 650.00, 'https://images.unsplash.com/photo-1527814050087-379381547969?q=80&w=800', 'Periféricos'),
